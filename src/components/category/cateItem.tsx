  ...
  return (
    <div className="flex h-64 gap-12">
      ...
      <div className="flex flex-col gap-4">
        ...
        <BtnLayout className="border-shelfTextColor whitespace-nowrap text-shelfTextColor hover:bg-shelfTextColor h-[2.5rem] w-full rounded-full text-xl duration-300 hover:text-white">
          자세히 보기
        </BtnLayout>
      </div>
    </div>
